...
Para amenizar o custo de tempo de execução, as simulações computacionais citadas anteriormente podem ser gerenciadas por um \abbrev{SGWfC}{Sistema de Gerência de Workflows Científicos} SGWfC (Sistema de Gerência de Workflows Científicos) paralelo, o que faz com que se beneficiem da proveniência e do paralelismo de dados entre os diferentes programas que compõem o seu \textit{workflow}~\cite{bux2013parallelization}.
