...
\lstdefinelanguage{pseudocode}{%
    % morekeywords={se,então,para,cada,faça,fim,função,retorna,enquanto,não,is,ou,e,senão,novo,termina,continua},
    morekeywords={if,then,for,each,do,end,function,return,while,not,is,or,and,else,new,break,continue},
...
% \includeonly{chapter03,chapter04,chapter05}
