...
\lstdefinelanguage{pseudocode}{%
    % morekeywords={se,então,para,cada,faça,fim,função,retorna,enquanto,não,is,ou,e,senão},
    morekeywords={if,then,for,each,do,end,function,return,while,not,is,or,and,else},
