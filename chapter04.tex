...
\silva{Isso não é uma descrição geral do DfAnalyzer. Aqui você mais apresentou o solver de sedimentação do que o DfAnalyzer. Ou seja, o DfAnalyzer não depende do solver. No caso, acho que você pode usar os dois próximos parágrafos no experimento.}
...
\silva{No solver, capturamos dados referentes ao resíduo do solver ao resolver as equações para o fluido e os sedimentos. Para a gerência de arquivos, consideramos os raw data files nos formatos XDMF e HDF5.}
