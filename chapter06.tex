...
O objetivo da quarta consulta é a análise dos resíduos e da normalização de delta dos últimas três passos executados. A especificação completa da consulta está disponível na \autoref{tab:experiments-4-especificacao}.
