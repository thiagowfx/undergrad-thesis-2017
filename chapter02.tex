...
\perrotta{REVIEW: Como explicar a igualdade do parágrafo anterior de forma sucinta?? Por favor veja se a explicação simplificada e o exemplo a seguir são suficientes.}
...
\perrotta{REVIEW: mecanismos para processamento de consultas??}
