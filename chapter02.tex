...
Um \textbf{atributo de dados} é especificado da seguinte forma: \[ da = (\textrm{nome},\textrm{tipo}) \therefore \textrm{tipo} \in \{\textup{inteiro}, \textup{ponto flutuante}, \textup{texto}, \textup{arquivo}\} \]
...
\begin{table}[ht]
    ...
    \begin{tabular}{|c|c|}
        \hline
        \multicolumn{2}{|c|}{Conjunto de dados: usuários} \\
        \hline
