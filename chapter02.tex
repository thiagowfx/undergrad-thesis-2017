...
Para ilustrar as definições e especificações da \autoref{sec:especificacoes}, vamos utilizar uma pequena amostra do conjunto de dados de sedimentação. \perrotta[Na \autoref{fig:example-dataflow-specification},]{expandir comentário sobre a figura}
