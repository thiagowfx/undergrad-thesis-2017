...
\silva{no referencial teórico, você tem a definição de gerência do fluxo de dados. Logo, você não deve dizer "apoio ao fluxo de dados". O adequado seria "gerência do fluxo de dados", como fiz no parágrafo anterior.}

\perrotta{REVIEW: tudo bem colocar esse exemplo aqui, ou é melhor incluí-lo no final?}
\silva{Esse exemplo não deve ser incluído, pois ele é uma cópia exata do artigo do CCPE. Além disso, acho que a ideia principal já foi passada quanto aos tipos de consulta.}
...
\silva{Atualizar refs de acordo com o artigo do CCPE e da ARMFUL}
...
\silva{Tomar cuidado, pois alguns termos em inglês não estão em itálico}

\silva{Pela sua descrição, observe que o Tigres também apoia consultas do tipo 3}
